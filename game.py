...
class Game:
    ...
    def __init__(self):
        ...
        self.game_over = GameObject(0, 0, self.width, self.height, 'assets/game_over.jpeg')
    ...
    def draw_objects(self):
        ...
        self.game_window.blit(self.game_over.image, (self.height, self.width))
        for enemy in self.enemies:
            self.game_window.blit(enemy.image, (enemy.x, enemy.y))
        # if self.detect_collision == False:
        #     self.game_window.blit(self.game_over.image, (self.background.x, self.background.y))
